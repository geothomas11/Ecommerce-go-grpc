...
const file_pkg_pb_admin_admin_proto_rawDesc = "" +
	...
	"\x13AdminLoginInRequest\x12\x14\n" +
	...
	"\fadminDetails\x18\x02 \x01(\v2\x13.admin.AdminDetailsR\fadminDetails\x12\x14\n" +
	"\x05token\x18\x03 \x01(\tR\x05token\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error2\x96\x01\n" +
	"\x05Admin\x12F\n" +
	"\vAdminSignup\x12\x19.admin.AdminSignupRequest\x1a\x1a.admin.AdminSignupResponse\"\x00\x12E\n" +
	"\n" +
	"AdminLogin\x12\x1a.admin.AdminLoginInRequest\x1a\x19.admin.AdminLoginResponse\"\x00B\x10Z\x0e./pkg/pb/adminb\x06proto3"
