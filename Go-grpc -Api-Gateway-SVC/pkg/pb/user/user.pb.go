...
const file_pkg_pb_user_user_proto_rawDesc = "" +
	"\n" +
	"\x16pkg/pb/user/user.proto\x12\x04user\"\x95\x01\n" +
	...
	"\x05phone\x18\x05 \x01(\tR\x05phone\"\xa7\x01\n" +
	...
	"\fRefreshToken\x18\x04 \x01(\tR\fRefreshToken\"D\n" +
	...
	"\tUserLogin\x12\x16.user.UserLoginRequest\x1a\x17.user.UserLoginResponse\"\x00B\x0fZ\r./pkg/pb/userb\x06proto3"
